...
% Active replacement: appendices/fisher_derivations.tex
...
process below, each child's environment is also uncorrelated with parental
...
Indeed, the derivation below gives
$\operatorname{Cov}(E_M,A_o)=\rho h e_P/2$, even though
